...
use super::generics::is_type_param_factory;
...
fn is_type_alias(node: &Node, source: &str) -> bool {
    const TYPE_CONSTRUCTORS: &[&str] = &[
        "Union", "Optional", "Callable", "Literal", "Annotated", "Final", "ClassVar", "Tuple",
        "List", "Dict", "Set", "FrozenSet", "Type", "Sequence", "Mapping", "MutableMapping",
        "Iterable", "Iterator", "Awaitable", "Coroutine", "Generator", "list", "dict", "set",
        "tuple", "frozenset", "type",
    ];

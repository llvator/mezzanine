...
//!
//! Mirrors [`crate::parser::rust::bodies::complexity`] and
...
pub(in crate::parser::python) fn compute_complexity(body: &Node) -> (u32, u32, u32) {
...
pub(in crate::parser::python) fn count_return_tuple_elements(

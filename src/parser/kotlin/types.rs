...
/// positives are cheap.
const STD_TYPES: &[&str] = &[
    "String", "Char", "Int", "Long", "Short", "Byte", "Float", "Double",
    "Boolean", "Unit", "Any", "Nothing", "Number", "CharSequence",
    "List", "MutableList", "Map", "MutableMap", "Set", "MutableSet",
    "Collection", "MutableCollection", "Iterable", "Iterator", "Array",
    "ByteArray", "IntArray", "LongArray", "Sequence", "Pair", "Triple",
    "Result", "Lazy", "Regex", "Throwable", "Exception", "Flow",
